...
module.exports = {
    ...
    create(context) {
        ...
        function checkDirectives(node) {
            ...
            // Only check before if directive has leading comments (including a shebang) or if it is
            // at the top of the file and checkBefore is set to "never". This is to not force a newline at the
            // top of the file if there are no comments as well as for compatibility with padded-blocks.
            if (
                directive.leadingComments && directive.leadingComments.length ||
                node.type === "Program" && beginsWithShebang()
            ) {
